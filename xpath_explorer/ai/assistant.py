...
def _compat_ai_module() -> Any:
    from xpath_explorer.tools import ai as ai_module
...
class XPathAIAssistant:
    ...
    def _save_config(self) -> AIConfigResult:
        compat = _compat_ai_module()
        config_path, source = compat.resolve_storage_file("ai_config.json")
    ...
    def _build_gemini_generate_config(system_prompt: str) -> Optional[Any]:
        ...
        types_module = _compat_ai_module().import_optional("google.genai.types")
    ...
    def _get_client(self) -> Optional[Any]:
        ...
        if self._provider == "openai":
            openai_module = _compat_ai_module().import_optional("openai")
            ...
            genai_module = _compat_ai_module().import_optional("google.genai")
